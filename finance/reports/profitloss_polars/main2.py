...
from reports.profitloss_polars.functions import filter, creategroup, preprocessing, processing
import pandas as pd
import numpy as np
import datetime, time
from reports.profitloss_polars.functions.createrangeaxis import create_range_axis
from reports.profitloss_polars.charts.r1_summary_profitloss import summary_profitloss_metrics
from reports.profitloss_polars.charts.r2_summary_profitloss import summary_profitloss_indicator, summary_profitloss_scorecard
from reports.profitloss_polars.charts.r3_summary_profitloss import summary_profitloss_grossprofit_year_bar, summary_profitloss_netoprprofit_year_bar
from reports.profitloss_polars.charts.r4_summary_profitloss import summary_profitloss_netprofit_year_bar
from reports.profitloss_polars.charts.r2_detail_profitloss import detail_profitloss_company, detail_profitloss_company_v2
from reports.profitloss_polars.charts.r3_detail_profitloss import detail_profitloss_brand, detail_profitloss_brand_v2
from reports.profitloss_polars.charts.r4_detail_profitloss import detail_profitloss_profitcenter, detail_profitloss_profitcenter_v2
from reports.profitloss_polars.charts.r5_detail_profitloss import detail_profitloss_table
from reports.profitloss_polars.charts.r6_detail_profitloss import detail_profitloss_profit_loss_statement
from reports.profitloss_polars.charts.r7_detail_profitloss import detail_profitloss_company_brand
    ...
    try:
        ...
        with tab2:
            ...
            with b1:
                ...
                pp_gross_profit = chart_data_gross_profit[chart_data_gross_profit['Brand'].isin(passenger_premium)]
                pp_netopr_profit = chart_data_netopr_profit[chart_data_netopr_profit['Brand'].isin(passenger_premium)]
                pp_net_profit = chart_data_net_profit[chart_data_net_profit['Brand'].isin(passenger_premium)]
                detail_profitloss_brand_v2(pp_gross_profit, pp_netopr_profit, pp_net_profit, "gross_profit", "net_operating_profit", "net_profit")
                
                st.subheader('R2 Brand')
                r2_gross_profit = chart_data_gross_profit[chart_data_gross_profit['Brand'].isin(r2)]
                r2_netopr_profit = chart_data_netopr_profit[chart_data_netopr_profit['Brand'].isin(r2)]
                r2_net_profit = chart_data_net_profit[chart_data_net_profit['Brand'].isin(r2)]
                detail_profitloss_brand_v2(r2_gross_profit, r2_netopr_profit, r2_net_profit, "gross_profit", "net_operating_profit", "net_profit")
            with b2:
                st.subheader('Passenger Non-Premium Brand')
                pnp_gross_profit = chart_data_gross_profit[~chart_data_gross_profit['Brand'].isin(all)]
                pnp_netopr_profit = chart_data_netopr_profit[~chart_data_netopr_profit['Brand'].isin(all)]
                pnp_net_profit = chart_data_net_profit[~chart_data_net_profit['Brand'].isin(all)]
                detail_profitloss_brand_v2(pnp_gross_profit, pnp_netopr_profit, pnp_net_profit, "gross_profit", "net_operating_profit", "net_profit")

                st.subheader('Truck Brand')
                truck_gross_profit = chart_data_gross_profit[chart_data_gross_profit['Brand'].isin(truck)]
                truck_netopr_profit = chart_data_netopr_profit[chart_data_netopr_profit['Brand'].isin(truck)]
                truck_net_profit = chart_data_net_profit[chart_data_net_profit['Brand'].isin(truck)]
                detail_profitloss_brand_v2(truck_gross_profit, truck_netopr_profit, truck_net_profit, "gross_profit", "net_operating_profit", "net_profit")
            #end region
        ...
        with tab3:
            ...
            with tab1:
                ...
                with c14:
                    lytd_sales = profit_loss_statement_all_year[(profit_loss_statement_all_year['PeriodYear'] == (str(select_year) if last_month != '12' else str(select_year-1))) &
            ...
            with tab2:                
                ...
                with c14:
                    lytd_cogs = np.abs(profit_loss_statement_all_year[(profit_loss_statement_all_year['PeriodYear'] == (str(select_year) if last_month != '12' else str(select_year-1))) &
            ...
            with tab3:
                ...
                with c14:
                    lytd_opex = np.abs(profit_loss_statement_all_year[(profit_loss_statement_all_year['PeriodYear'] == (str(select_year) if last_month != '12' else str(select_year-1))) &
            ...
            with tab4:
                ...
                with c14:
                    lytd_otherin = np.abs(profit_loss_statement_all_year[(profit_loss_statement_all_year['PeriodYear'] == (str(select_year) if last_month != '12' else str(select_year-1))) &
            ...
            with tab5:
                ...
                with c14:
                    lytd_otherex = np.abs(profit_loss_statement_all_year[(profit_loss_statement_all_year['PeriodYear'] == (str(select_year) if last_month != '12' else str(select_year-1))) &
