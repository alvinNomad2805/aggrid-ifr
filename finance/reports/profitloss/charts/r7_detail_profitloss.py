...
def detail_profitloss_company_brand(data_source, field, company_brand, label=""):
    fig = go.Figure(
        go.Bar(name=field, 
            x=data_source[field],
    ...
    st.plotly_chart(fig, use_container_width=True, key=f"detail_profitloss_company_brand{label}")
