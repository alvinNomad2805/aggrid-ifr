...
def detail_profitloss_company(data_source, field, range_axis):
    fig = go.Figure(
        go.Bar(name=field, 
            x=data_source[field],
            y=data_source['console_combine_name'],
            orientation='h',
    ...
    st.plotly_chart(fig, use_container_width=True,key="detail_profitloss_company")

def detail_profitloss_company_v2(data_source1, data_source2, data_source3, field1, field2, field3):
    ...
    fig = go.Figure(data=[
        go.Bar(name='Gross Profit (Rp. Million)', 
                ...
                y=data_source1['console_combine_name'],
                orientation='h',
        ...
        go.Bar(name='Net Operating Profit (Rp. Million)', 
                ...
                y=data_source2['console_combine_name'],
                orientation='h',
        ...
        go.Bar(name='Net Profit (Rp. Million)', 
                ...
                y=data_source3['console_combine_name'],
                orientation='h',
    ...
    fig.update_traces(textangle=0)
    st.plotly_chart(fig, use_container_width=True,key="detail_profitloss_company_v2")