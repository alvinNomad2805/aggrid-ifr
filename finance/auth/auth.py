...
from data.LoadData import load_data_users
from data.UpdateData import update_password
from auth.Hashing import Hasher
from auth.Validation import Validator
from utils.passgen import generate_random_pw
...
class Authenticate:
    ...
    def _check_pw(self) -> bool:
        ...
        """
        get_data = load_data_users(f"/login/?username={self.username}")
        return bcrypt.checkpw(self.password.encode(),get_data.encode())
